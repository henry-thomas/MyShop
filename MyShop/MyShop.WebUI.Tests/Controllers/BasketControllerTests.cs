...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "henrythomastzn@live.com", ZipCode = "7441" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("henrythomastzn@live.com", "Forms"), null);
